...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    public class AeroplanePropellerAnimator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            //m_PropellorModelRenderer = m_PropellorModel.transform.GetChild(0).GetComponent<Renderer>();
            //m_PropellorBlurRenderer = m_PropellorBlur.transform.GetChild(0).GetComponent<Renderer>();
